...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/admin","/api/admin/AllUser","/api/admin/{adminId}","/api/admin/updatePicture/{adminId}")
                .permitAll()
                .requestMatchers("/api/auth/login","/api/admin/changePass/{userId}")
